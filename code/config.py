...
def get_opt():
    ...
    parser.add_argument('--use_sief', action='store_true', default=False)
    parser.add_argument('--sief_beta', type=float, default=0.8)
    ...
    if args.use_model == "bilstm":
        ...
        args.train_set_save = os.path.join(args.prepro_dir,"train_"+"_".join(bert_name.split("-"))+".pkl")
        args.dev_set_save = os.path.join(args.prepro_dir,"dev_"+"_".join(bert_name.split("-"))+".pkl")
        args.test_set_save = os.path.join(args.prepro_dir,"test_"+"_".join(bert_name.split("-"))+".pkl")
        args.entity_type_size = 20
        args.entity_id_size = 20
        args.sent_id_size = 20
    else:
